...
| 文書 | 何が書いてあるか |
|---|---|
| `DESIGN_SYSTEM.md` | **いま何が正か。** 読めば従える規範。§8「実装の規範」に、赤・破線・移動の言葉・枠取りなどの規則 |
| `DECISIONS.md` | **いつ何をなぜ決めたか。** 経緯と、却下した案とその理由 |

新しく決めたら `DECISIONS.md` に1件積む。規範が変わったなら
`DESIGN_SYSTEM.md` も直す。**却下した案は必ず理由と一緒に残す** —
間違ったほうは単独で見るとたいてい妥当に見えるので、それが分からないと
同じ道を辿る。
